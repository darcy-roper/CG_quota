...
while True:
    for item in event_list:
        event = item
        sys.stdout = open('/Users/newmac/Desktop/Programs and Code/AUS_female' + '_' + event + '_CommsRank' + '.txt', 'wt')
        ...
        driver.get("https://www.worldathletics.org/world-rankings/" + event + "/women?regionType=country-group&region=commonwealth%20games&page=1&rankDate=&limitByCountry=3")  # EVENT URL LIMITES TO 4 PER COUNTRY
        time.sleep(0.5)
        ...
        while counter < 101:
            try:
                athlete_tab = driver.find_element(By.XPATH, '//*[@id="toplists"]/div[3]/table/tbody/tr['+str(counter)+']')  # tr1 needs to increase each run through the loop
