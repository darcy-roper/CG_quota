...
event10kw = str("20km-race-walking")
eventMAR = str("marathon")
# make list from variables [event100, event200, event400, event800, event1500, eventSC, event5K, event10K, event100H, event400H, eventLJ, eventTJ, eventHJ, eventPV, eventDT, eventHT, eventJT, eventSP, event10kw, eventMAR #eventX10 seperate
...
event_list = [event200, event400, event800, event1500, eventSC, event5K, event10K, event100H, event400H, eventLJ, eventTJ, eventHJ, eventPV, eventDT, eventHT, eventJT, eventSP, event10kw, eventMAR]
...
while True:
    for item in event_list:
        ...
        sys.stdout = open('/Users/newmac/Desktop/Programs and Code/Toplist21_male' + '_' + event + '_CommsRank' + '.txt', 'wt') # want to automate the folder selection process
        ...
        season.click()
        year = driver.find_element(By.XPATH, '//*[@id="season"]/option[2]')  # option 2 is 2021
        year.click()
        #selecting gender
        gender = driver.find_element(By.XPATH, '//*[@id="gender"]')
        gender.click()
        female = driver.find_element(By.XPATH, '//*[@id="gender"]/option[1]')  # option 2 is female
        female.click()
        #selecting event
        ...
        while counter < 101:
            try:  # Nationality IF statements are unique to the envent because the columnb ordering changes between events
                ...
                elif event == "400m" or event == "800m" or event == "1500m" or event == "3000msc" or event == "5000m" or event == "10000m" or event == "400mh"  or event == "pole-vault" or event == "high-jump" or event == "shot-put" or event == "discus-throw" or event == "javelin-throw" or event == "hammer-throw" or event == "20km-race-walking" or event == "marathon":
