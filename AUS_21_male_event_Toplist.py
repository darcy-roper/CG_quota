...
# make list from variables [event100, event200, event400, event800, event1500, eventSC, event5K, event10K, event110H, event400H, eventLJ, eventTJ, eventHJ, eventPV, eventDT, eventHT, eventJT, eventSP, event20kw, eventMAR  # eventX10 seperate
...
event_list = [event100, event200, event400, event800, event1500, eventSC, event5K, event10K, event110H, event400H, eventLJ, eventTJ, eventHJ, eventPV, eventDT, eventHT, eventJT, eventSP, event20kw, eventMAR] #add hep later
...
while True:
    for item in event_list:
        ...
        sys.stdout = open('/Users/newmac/Desktop/Programs and Code/AUS_male_21' + '_' + event + '_Toplist' + '.txt', 'wt') # want to automate the folder selection process
        ...
        gender.click()
        male = driver.find_element(By.XPATH, '//*[@id="gender"]/option[1]')  # option 1 is male
        male.click()
        #selecting event
